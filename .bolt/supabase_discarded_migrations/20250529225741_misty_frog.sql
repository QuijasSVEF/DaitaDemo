/*
  # Implement AI-driven Lesson Plan Generation
  
  1. New Functions
    - `generate_ai_lesson_plan`: Creates personalized lesson plans using OpenAI
    - `get_lesson_plan_by_exit_ticket`: Retrieves lesson plan for a specific exit ticket
    - `regenerate_lesson_plan`: Regenerates a lesson plan with new activities
    
  2. Features
    - Personalized lesson plans based on student struggles
    - Grade-appropriate content
    - UDL framework with DOK levels
    - Detailed activities with teacher scripts and materials
    - Standards alignment
*/
    ...
    'detailedActivities', jsonb_build_object(
      ...
      'representation', jsonb_build_array(
        jsonb_build_object(
          ...
          'teacherScript', ARRAY[
            ...
            'Here\'s how we see this in the real world...'
          ],
          'studentBehaviors', ARRAY[
      ...
      'actionExpression', jsonb_build_array(
        jsonb_build_object(
          ...
          'teacherScript', ARRAY[
            'Now you\'ll have a chance to apply what we\'ve learned',
            'Choose the approach that makes most sense to you',
            'I\'ll be coming around to provide feedback',
      ...
      'wrapup', jsonb_build_array(
        jsonb_build_object(
          ...
          'teacherScript', ARRAY[
            'Let\'s take a moment to reflect on what we learned today',
            ...
            'Tomorrow we\'ll build on this by exploring...'
          ],
          'studentBehaviors', ARRAY[
