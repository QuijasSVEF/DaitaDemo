/*
  # Fix Exit Tickets RLS and Student Validation
  
  1. Changes
    - Drop existing policies for exit_tickets
    - Create new comprehensive policy for all operations
    - Add function to validate and create students if needed
    - Fix authentication issues with exit ticket submission
    
  2. Security
    - Ensure proper RLS enforcement
    - Allow authenticated teachers to manage their exit tickets
    - Validate teacher status before operations
*/
