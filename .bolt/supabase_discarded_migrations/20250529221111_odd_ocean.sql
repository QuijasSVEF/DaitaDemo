/*
  # Enhance Lesson Plan Generation with AI
  
  1. New Function
    - `generate_lesson_plan`: Creates personalized, AI-generated lesson plans
    - Includes detailed activities tailored to student needs
    - Incorporates grade-level standards
    - Provides creative, varied teaching approaches
    
  2. Features
    - Personalized objectives based on struggle areas
    - Varied engagement activities
    - Multiple representation strategies
    - Diverse action/expression tasks
    - Thoughtful wrap-up activities
    - Standards alignment
    - DOK level assignment
*/
    ...
    'detailedActivities', jsonb_build_object(
      'engagement', jsonb_build_array(
        jsonb_build_object(
          ...
          'teacherScript', ARRAY[
            'Today we're exploring ' || COALESCE(p_struggled_areas[1], 'this concept') || ' in a new way.',
            'I notice you're making connections between...',
