...
export function StudentAssessment({ studentId, teacherUsername, student, onBack, onAssessmentComplete }: Props) {
          ...
          <div className="space-y-3">
            {onAssessmentComplete && (
              <button
                ...
                className="w-full inline-flex items-center justify-center px-4 py-3 border border-transparent rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 font-medium"
              >
                Log My Session
              </button>
            )}
            <button
              onClick={onBack}
              className="w-full inline-flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-svef-gray bg-white hover:bg-gray-50"
            >
