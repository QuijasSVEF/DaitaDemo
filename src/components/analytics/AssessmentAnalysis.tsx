                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                      <div className="text-right hidden sm:block">
                        <p className={cn(
                          ...
                          q.incorrectPct >= 70 ? 'text-red-600' :
                          q.incorrectPct >= 50 ? 'text-amber-600' :
                          'text-gray-600'
                        )}>
                          {q.incorrectPct}% incorrect
                        </p>
                        <p className="text-xs text-gray-400">
                          {q.incorrectCount} of {q.totalAttempts} students
                        </p>
                      </div>
                      ...
                      <div className="w-20 h-2.5 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          className={cn(
                            ...
                            q.incorrectPct >= 70 ? 'bg-red-400' :
                            q.incorrectPct >= 50 ? 'bg-amber-400' :
                            q.incorrectPct >= 30 ? 'bg-yellow-300' :
                            'bg-green-400'
                          )}
